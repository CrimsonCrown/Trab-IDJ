...
main: Game State Sprite  Music
	g++ -std=c++11 -g -Wall main.cpp Game.o State.o Sprite.o Music.o -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
...
Music:
	g++ -std=c++11 -c -g -Wall Music.cpp -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer
